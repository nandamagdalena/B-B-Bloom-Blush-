...
<div class="container mx-auto px-4 py-6 text-white">
    <h1 class="text-2xl font-bold mb-6">Tambah Suplier</h1>

    <form action="{{ route('supliers.store') }}" method="POST" class="space-y-4">
        @csrf
        <div>
        ...
        <div>
            ...
            <input type="text" name="alamat" class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-white">
        </div>

        <div>
            <label class="block mb-1">Kode Pos</label>
            <input type="text" name="kode_pos" class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-white">
        </div>
